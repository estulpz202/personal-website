...
export default function EducationSection() {
  ...
  return (
    <section className="py-10 fade-in-up">
      ...
      <div className="relative h-[280px] perspective">
        {/* Card Container */}
        <div
        ...
        >
          {/* Front Side */}
          <div
            className="absolute w-full h-full bg-white rounded-xl shadow-sm border border-gray-200 p-6 backface-hidden cursor-pointer"
          ...
          >
            <div className="flex items-start">
              ...
              <div className="ml-5 flex-grow">
                <div className="flex flex-col md:flex-row md:items-center justify-between">
                  ...
                  <span className="text-gray-600 text-base font-medium">Aug 2023 - May 2027</span>
                </div>
                <p className="text-indigo-600 font-medium mt-1">
                  Bachelor of Science in Computer Science
                </p>
                <p className="text-gray-600">
                  Concentration in Software Engineering • Minor in History
                </p>
            ...
            <div className="absolute bottom-4 right-4 text-gray-400 opacity-60">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
          ...
          {/* Back Side */}
          <div
            className="absolute w-full h-full bg-white rounded-xl shadow-sm border border-gray-200 p-6 backface-hidden rotate-y-180 cursor-pointer"
