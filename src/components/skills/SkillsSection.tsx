...
export default function SkillsSection() {
  ...
  return (
    <section className="py-5 sm:py-6 md:py-7">
      ...
      {/* Skills Content */}
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 pb-4 px-4 pt-0 sm:pb-5 sm:px-5 sm:pt-1 md:pb-6 md:px-6 md:pt-2">
          ...
          {skillsData[activeTab].skills.map((skill) => (
            <div
              ...
              className="
                ...
                flex items-center gap-2 sm:gap-3 hover:border-indigo-200 active:border-indigo-200 transition-colors
              "
            >
