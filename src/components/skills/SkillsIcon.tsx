  ...
  const iconMap: Record<string, React.ReactNode> = {
    ...
    c: (
      <svg viewBox="0 0 128 128" className={className}>
        ...
        <path
          fill="#fff"
          d="M85.3 76.1C81.1 83.5 73.1 88.5 64 88.5c-13.5 0-24.5-11-24.5-24.5s11-24.5 24.5-24.5c9.1 0 17 4.9 21.3 12.3l13-7.5C92.1 32.1 79.5 26 64 26c-20.9 0-38 17.1-38 38s17.1 38 38 38c15.5 0 28.1-6.1 34.4-18.2l-13.1-7.7z"
        ></path>
      </svg>
    ),
    fastapi: (
      <svg viewBox="0 0 154 154" className={className}>
    ...
    github: (
      <svg viewBox="0 0 128 128" className={className}>
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M64 5.103c-33.347 0-60.388 27.035-60.388 60.388 0 26.682 17.303 49.317 41.297 57.303 3.017.56 4.125-1.31 4.125-2.905 0-1.44-.056-6.197-.082-11.243-16.8 3.653-20.345-7.125-20.345-7.125-2.747-6.98-6.705-8.836-6.705-8.836-5.48-3.748.413-3.67.413-3.67 6.063.425 9.257 6.223 9.257 6.223 5.386 9.23 14.127 6.562 17.573 5.02.542-3.903 2.107-6.568 3.834-8.076-13.413-1.525-27.514-6.704-27.514-29.843 0-6.593 2.36-11.98 6.223-16.21-.628-1.52-2.695-7.662.584-15.98 0 0 5.07-1.623 16.61 6.19C53.7 35 58.867 34.327 64 34.27c5.13.057 10.3.73 15.13 2.034 11.526-7.813 16.59-6.19 16.59-6.19 3.287 8.317 1.22 14.46.593 15.98 3.872 4.23 6.215 9.617 6.215 16.21 0 23.194-14.127 28.3-27.574 29.796 2.167 1.874 4.097 5.55 4.097 11.183 0 8.08-.07 14.583-.07 16.572 0 1.607 1.088 3.49 4.148 2.897 23.98-7.994 41.263-30.622 41.263-57.294C124.388 32.14 97.35 5.104 64 5.104z"
        ></path>
        <path d="M26.484 91.806c-.133.3-.605.39-1.035.185-.44-.196-.685-.605-.543-.906.13-.31.603-.395 1.04-.188.44.197.69.61.537.91zm2.446 2.729c-.287.267-.85.143-1.232-.28-.396-.42-.47-.983-.177-1.254.298-.266.844-.14 1.24.28.394.42.472.984.17 1.255zM31.312 98.012c-.37.258-.976.017-1.35-.52-.37-.538-.37-1.183.01-1.44.373-.258.97-.025 1.35.507.368.545.368 1.19-.01 1.452zm3.261 3.361c-.33.365-1.036.267-1.552-.23-.527-.487-.674-1.18-.343-1.544.336-.366 1.045-.264 1.564.23.527.486.686 1.18.333 1.543zm4.5 1.951c-.147.473-.825.688-1.51.486-.683-.207-1.13-.76-.99-1.238.14-.477.823-.7 1.512-.485.683.206 1.13.756.988 1.237zm4.943.361c.017.498-.563.91-1.28.92-.723.017-1.308-.387-1.315-.877 0-.503.568-.91 1.29-.924.717-.013 1.306.387 1.306.88zm4.598-.782c.086.485-.413.984-1.126 1.117-.7.13-1.35-.172-1.44-.653-.086-.498.422-.997 1.122-1.126.714-.123 1.354.17 1.444.663zm0 0"></path>
      </svg>
    ),
    devops: (
    ...
    firebase: (
      ...
      >
        ...
        <path
          ...
          fill="#FFC24A"
        />
        <use fill="#FFA712" fillRule="evenodd" xlinkHref="#fb-a" />
        <use filter="url(#fb-b)" xlinkHref="#fb-a" />
        <path
          d="M135.005 150.38l32.955-33.75-32.965-62.93c-3.129-5.957-11.866-5.975-14.962 0L102.42 87.287v2.86l32.584 60.233z"
          fill="#F4BD62"
        />
        <use fill="#FFA50E" fillRule="evenodd" xlinkHref="#fb-c" />
        <use filter="url(#fb-d)" xlinkHref="#fb-c" />
        <path
          fill="#F6820C"
    ...
    scrum: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" className={className}>
        <g>
          <path
            fill="#7c8c8e"
            d="M60.29,49.2l-2,1.99a.96687.96687,0,0,1-.7.29H18V45.5H57.59a.96687.96687,0,0,1,.7.29l2,1.99A1.008,1.008,0,0,1,60.29,49.2Z"
          ></path>
          <path
            d="M38.27,45.5a17.62136,17.62136,0,0,1-1.41,1.31,20.09651,20.09651,0,0,1-12.84,4.67H8a1.87807,1.87807,0,0,1-2-1.71V47.21A1.878,1.878,0,0,1,8,45.5Z"
            opacity=".1"
          ></path>
          <path
            fill="#4cd0f7"
            d="M33.86,46.81a20.09651,20.09651,0,0,1-12.84,4.67H5a1.87807,1.87807,0,0,1-2-1.71V47.21A1.878,1.878,0,0,1,5,45.5H21.02a14.12287,14.12287,0,0,0,8.99-3.28,13.99941,13.99941,0,0,0-15.54-23.1l2.33,1.55a.99721.99721,0,0,1-.06,1.7L6.65,28.07a.99518.99518,0,0,1-1.49-.87V14.78a.99541.99541,0,0,1,1.55-.83L9.04,15.5A19.98456,19.98456,0,0,1,33.86,46.81Z"
          ></path>
          <path
            d="M40.21,25.9A6.0538,6.0538,0,0,0,40,27.5a1.99913,1.99913,0,0,1-3.96.39A1.66745,1.66745,0,0,1,36,27.5a10.49567,10.49567,0,0,1,2.13-6.34A19.32378,19.32378,0,0,1,40.21,25.9Z"
            opacity=".1"
          ></path>
          <path
            fill="#a36ba7"
            d="M60.91,23.91,56.96,32.9a.98758.98758,0,0,1-1.67.24l-1.07-1.26-4.77-5.63a1.00841,1.00841,0,0,1,.57-1.63L52.91,24A6.49319,6.49319,0,0,0,40,25a1.99913,1.99913,0,0,1-3.96.39A1.66745,1.66745,0,0,1,36,25a10.50315,10.50315,0,0,1,20.36-3.6,11.1005,11.1005,0,0,1,.47,1.76l2.49-.53.47-.1A.99579.99579,0,0,1,60.91,23.91Z"
          ></path>
        </g>
      </svg>
    ),
